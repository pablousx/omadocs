...
```bash
python3 .github/scripts/setup_repository.py --repo pablousx/omadocs
python3 .github/scripts/setup_repository.py --repo pablousx/omadocs --apply
```
